   ...
   Atributos:
     tipo  = "psicologo" | "paciente"
      ...
      ativo = qual item aparece destacado:
              psicologo: "inicio" | "agenda" | "notas" | "disponibilidades" | "pacientes" | "relatorios" | "perfil" | ""
...
(function () {
  ...
  var ICON_NOTAS = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M8 13h8M8 17h5"/><path d="m15 17 4-4 2 2-4 4-3 1z"/></svg>';
  ...
  function menuPsicologo(ativo) {
    ...
    return (
      ...
      '        ' + item(prefixoPagina + 'notas.html', ICON_NOTAS, 'Notas rápidas', ativo === 'notas') + '\n' +
